...
exports.saveDocument = exports.dbPath = void 0;
const better_sqlite3_1 = __importDefault(require("better-sqlite3"));
const path = __importStar(require("path"));
const electron_1 = require("electron");
// OS의 userData 폴더 (AppData 등)에 db 파일 생성
exports.dbPath = path.join(electron_1.app.getPath('userData'), 'writingApp.db');
console.log('---');
console.log('SQLite DB 위치:', exports.dbPath);
console.log('---');
